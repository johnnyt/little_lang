...
-file("src/number_lexer.erl", 307).
yystate() -> 22.

yystate(23, [10|Ics], Line, Tlen, _, _) ->
    yystate(6, Ics, Line+1, Tlen+1, 2, Tlen);
...
yystate(7, [48|Ics], Line, Tlen, Action, Alen) ->
    yystate(21, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 49, C =< 57 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/number_lexer.xrl", 17).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/0}).
-file("src/number_lexer.xrl", 18).
yyaction_1() ->
     skip_token .

-compile({inline,yyaction_2/0}).
-file("src/number_lexer.xrl", 19).
yyaction_2() ->
     skip_token .

-compile({inline,yyaction_3/2}).
-file("src/number_lexer.xrl", 20).
yyaction_3(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("src/number_lexer.xrl", 21).
yyaction_4(TokenChars, TokenLine) ->
