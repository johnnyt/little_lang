...
-module(expreso_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/expreso_lexer.xrl", 32).
...
-file("src/expreso_lexer.erl", 310).
yystate() -> 33.
...
yystate(37, [10|Ics], Line, Tlen, _, _) ->
    yystate(37, Ics, Line+1, Tlen+1, 15, Tlen);
...
yystate(33, [105|Ics], Line, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(33, [103|Ics], Line, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(33, [104|Ics], Line, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
...
yystate(33, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(37, Ics, Line, Tlen+1, Action, Alen);
yystate(33, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(33, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(33, [C|Ics], Line, Tlen, Action, Alen) when C >= 98, C =< 101 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(33, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 108 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
