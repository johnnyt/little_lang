...
-file("src/list_lexer.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/list_lexer.xrl", 8).
yyaction_1(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, to_atom (TokenChars) } } .

-compile({inline,yyaction_2/1}).
-file("src/list_lexer.xrl", 9).
yyaction_2(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/list_lexer.xrl", 10).
yyaction_3(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/list_lexer.xrl", 11).
yyaction_4(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_5/0}).
-file("src/list_lexer.xrl", 12).
yyaction_5() ->
     skip_token .
