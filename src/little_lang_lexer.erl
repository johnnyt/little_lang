-file("/Users/johnnyt/.asdf/installs/erlang/23.0/lib/parsetools-2.2/include/leexinc.hrl", 0).
...
-module(little_lang_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/little_lang_lexer.xrl", 33).
...
-file("src/little_lang_lexer.erl", 310).
yystate() -> 44.
...
yystate(48, [10|Ics], Line, Tlen, _, _) ->
    yystate(48, Ics, Line+1, Tlen+1, 18, Tlen);
...
yystate(44, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(44, [C|Ics], Line, Tlen, Action, Alen) when C >= 99, C =< 101 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(44, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 109 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(44, [C|Ics], Line, Tlen, Action, Alen) when C >= 112, C =< 114 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(44, [C|Ics], Line, Tlen, Action, Alen) when C >= 117, C =< 122 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
...
yystate(35, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(35, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 57 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(35, [C|Ics], Line, Tlen, Action, Alen) when C >= 59, C =< 62 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(35, [C|Ics], Line, Tlen, Action, Alen) when C >= 64, C =< 91 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
...
yystate(32, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(32, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 62 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(32, [C|Ics], Line, Tlen, Action, Alen) when C >= 64, C =< 91 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
...
yystate(27, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(27, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 62 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(27, [C|Ics], Line, Tlen, Action, Alen) when C >= 64, C =< 91 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
...
yystate(20, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(20, [C|Ics], Line, Tlen, Action, Alen) when C >= 11 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
...
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 62 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 64, C =< 91 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
...
yystate(11, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(11, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 62 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
...
yystate(4, [63|Ics], Line, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [58|Ics], Line, Tlen, Action, Alen) ->
...
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 57 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 59, C =< 62 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
