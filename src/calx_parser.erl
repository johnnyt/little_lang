...
yeccpars2_3(S, '(', Ss, Stack, T, Ts, Tzr) ->
 yeccpars1(S, 2, Ss, Stack, T, Ts, Tzr);
yeccpars2_3(S, digit, Ss, Stack, T, Ts, Tzr) ->
...
yeccgoto_arg_list(3, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_5(5, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_arg_list(6=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_7(_S, Cat, Ss, Stack, T, Ts, Tzr).
...
-file("src/calx_parser.erl", 280).
-compile({inline,yeccpars2_6_/1}).
-file("src/calx_parser.yrl", 15).
yeccpars2_6_(__Stack0) ->
 [__1 | __Stack] = __Stack0,
 [begin
   [ { digit , ? l2i ( value_of ( __1 ) ) } ]
  end | __Stack].

-file("src/calx_parser.erl", 289).
-compile({inline,yeccpars2_7_/1}).
-file("src/calx_parser.yrl", 16).
yeccpars2_7_(__Stack0) ->
 [__2,__1 | __Stack] = __Stack0,
 [begin
   [ { digit , ? l2i ( value_of ( __1 ) ) } ] ++ __2
  end | __Stack].

-compile({inline,yeccpars2_8_/1}).
-file("src/calx_parser.yrl", 12).
yeccpars2_8_(__Stack0) ->
 [__4,__3,__2,__1 | __Stack] = __Stack0,
 [begin
   { expr , value_of ( __2 ) , __3 }
  end | __Stack].


-file("src/calx_parser.yrl", 27).
